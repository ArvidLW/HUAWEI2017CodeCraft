...
#define MIN_VALUE 0.011              //用来界定选择服务器,serverID 0.0005
#define MIN_VALUE_ZERO 0.005        //用来界定所有备选服务器,serverCandidate 0.000001
#define MIN_VALUE_ZERO_DOWN 0.0001     //界定线性规划包含的可能服务器,serverPossible 0.000005
